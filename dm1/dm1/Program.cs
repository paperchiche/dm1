...
namespace dm1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StreamWriter countspwr = new StreamWriter(@"C:\dm3semestr\text1.1.txt");
            ...
            StreamWriter countspermut = new StreamWriter(@"C:\dm3semestr\text1.2.txt");
            ...
            StreamWriter countsPNR = new StreamWriter(@"C:\dm3semestr\text1.3.txt");
            ...
            StreamWriter countsSubst = new StreamWriter(@"C:\dm3semestr\text1.4.txt");
            ...
            StreamWriter countsComb = new StreamWriter(@"C:\dm3semestr\text1.5.txt");
            ...
            StreamWriter countscwr = new StreamWriter(@"C:\dm3semestr\text1.6.txt");
